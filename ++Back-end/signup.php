...
<body style="font-family:'Source Sans Pro', sans-serif;background-color:rgb(29,109,147);">
    <div class="register-photo" style="background-color:rgb(29,109,147);">
        <div class="form-container">
            <div data-aos="fade-down" class="image-holder"></div>
