...
<body style="font-family:'Allerta Stencil', sans-serif;">
    ...
    <div id="promo">
        <div class="jumbotron">
            <h1 class="text-primary">Event Artist</h1>
            <p>Realize your dream event with the most amazing events possible and the best experience</p>
            <p></p>
        </div>
    </div>
    <div class="simple-slider">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image:url(&quot;assets/img/konser2.png&quot;);">
                    <div></div>
                </div>
                <div class="swiper-slide" style="background-image:url(&quot;assets/img/konser.jpg&quot;);"></div>
                <div class="swiper-slide" style="background-image:url(&quot;assets/img/slider.jpg&quot;);"></div>
            </div>
    ...
    <div class="photo-gallery">
        <div class="container">
            <div class="intro">
                <h2 class="text-center" style="font-family:'Allerta Stencil', sans-serif;color:rgb(24,78,142);">Event Gallery</h2>
                <p class="text-center">Realize your dream event with the most amazing events possible and the best experience<br></p>
            </div>
            <div class="row photos">
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="assets/img/desk.jpg" data-lightbox="photos"><img class="img-fluid" src="assets/img/slider3.jpeg"></a>
                    <h4 class="text-center" style="color:rgb(24,78,142);">Jakarta Selatan</h4>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="assets/img/building.jpg" data-lightbox="photos"><img class="img-fluid" src="assets/img/konser1.jpg"></a>
                    <h4 class="text-center" style="color:rgb(24,78,142);">Bandung</h4>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="assets/img/loft.jpg" data-lightbox="photos"><img class="img-fluid" src="assets/img/konser3.jpg"></a>
                    <h4 class="text-center" style="color:rgb(24,78,142);">Surabaya</h4>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="assets/img/building.jpg" data-lightbox="photos"><img class="img-fluid" src="assets/img/konser.jpg"></a>
                    <h4 class="text-center" style="color:rgb(24,78,142);">Malang</h4>
                </div>
            </div>
        </div>
    </div>
