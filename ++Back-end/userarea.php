...
<body style="background-color:#d5e0f1;">
    <div>
        <div class="header-blue" style="font-family:'Allerta Stencil', sans-serif;height:500px;padding-top:60px;padding-bottom:40pc;">
            <nav class="navbar navbar-dark navbar-expand-lg fixed-top navigation-clean-search" style="background-size:cover;background-repeat:no-repeat;background-color:rgb(29,109,147);height:70px;">
                <div class="container"><a class="navbar-brand" href="userarea.php" data-aos="fade-left" data-aos-duration="500" style="font-family:Amita, cursive;font-size:31px;">Artist.co</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div
                        ...
                        <ul class="nav navbar-nav" style="font-size:12;">
                            <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" data-aos="fade">ABOUT</a>
                                <div class="dropdown-menu visible" role="menu"><a class="dropdown-item disabled" role="presentation" href="about.php">ABOUT ARTIST.CO</a>
                                    <div class="dropdown-divider" role="presentation"></div><a class="dropdown-item disabled" role="presentation" href="contact.php">OUR CONTACT</a></div>
                            </li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="brand.php" style="font-family:'Allerta Stencil', sans-serif;">BRAND</a></li>
                        ...
                        </form><a class="btn btn-light action-button" role="button" href="logout.php" data-aos="fade-up" data-aos-duration="500">Log Out</a>
    ...
    <div class="features-blue" style="background-color:rgb(28,114,149);background-image:url(&quot;0&quot;);">
        <div class="container">
            <div class="intro">
    ...
    <div class="team-clean">
        <div class="container">
            ...
            <div class="row people">
                <div class="col-md-6 col-lg-4 item"><img class="rounded-circle" src="assets/img/ninoon.jpg">
                    <h3 class="name">Ninon Oktaviani Irawan</h3>
                ...
                <div class="col-md-6 col-lg-4 item"><img class="rounded-circle" src="assets/img/2.jpg">
                    <h3 class="name">Nur Hidayatullah</h3>
                    <p class="title">Artist</p>
                    <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, et interdum justo suscipit id. Etiam dictum feugiat tellus, a semper massa. </p>
                    <div class="social"><a href="#"><i class="fa fa-facebook-official"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-instagram"></i></a></div>
                </div>
                <div class="col-md-6 col-lg-4 item"><img class="rounded-circle" src="assets/img/ruri.jpg">
                    <h3 class="name">Ruri Ayyul Maulidya</h3>
